...
// ── DatePicker ─────────────────────────────────────────────────────────
// Fully custom themed calendar dropdown matching the site's dark navy palette.
...
function DatePicker({ value, onChange, max, min, hasError, placeholder }: DatePickerProps) {
  ...
  const displayValue = value
    ? new Date(value + "T12:00:00").toLocaleDateString("en-AU", { day: "2-digit", month: "short", year: "numeric" })
    : "";
